      ...
      <div class="row">
        ...
        >
          <template slot="title" slot-scope="data">
            <router-link
              :to="'initiative/?orgId='+$store.state.organization.id +'&initiativeid='+ data.item.id"
          ...
          <template slot="author" slot-scope="data" class="col-4">
            ...
            <div style="float: right;">
              ...
              <b-button
                ...
                size="sm"
                v-b-modal.delete
                @click="setCurrentInitiative(data.item)"
              >
          ...
          <template slot="importance" slot-scope="data" class="col-4">
            <a :href="`#`" v-on:click="filter = data.item.importance">{{ data.item.importance }}</a>
          </template>
          <template slot="horizon" slot-scope="data">
            <a
              :href="`#`"
              v-on:click="filter = data.item.horizon.horizon"
