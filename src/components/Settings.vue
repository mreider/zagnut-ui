<template>
  <div class="settings">
    <b-tabs>
      <b-tab title="Profile"> <profile :organizations='organizations'></profile> </b-tab>
      <b-tab title="Organization"> <organization :organizations='organizations'></organization> </b-tab>
      <b-tab title="Users"> <users :organizations='organizations'></users> </b-tab>
    </b-tabs>
  </div>
</template>
